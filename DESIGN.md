...
- Hosted app processes data in session memory only; no long‑term storage by default.
- Provide a clear privacy notice in the UI and an option to download and purge session data.
